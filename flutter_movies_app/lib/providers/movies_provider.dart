...
class MoviesProvider extends ChangeNotifier {
  final String _apiKey = 'b6d5864ebb5b7f30e7cd8229769106ab';
  final String _baseUrl = 'api.themoviedb.org';
  final String _language = 'es-ES';

  List<Movie> onDisplayMovies = [];
  List<Movie> popularMovies = [];
  List<Movie> popularStreaming = [];

  Map<int, List<Cast>> moviesCast = {};

  int _popularMoviesPage = 0;
  int _popularStreamingPage = 0;
  ...
  getPopularStreaming() async {
    _popularStreamingPage++;

    final jsonData =
        await _getJsonData('3/movie/popular', _popularStreamingPage);
    final popularStreamingResponse = PopularResponse.fromJson(jsonData);

    popularStreaming = [
      ...popularStreaming,
      ...popularStreamingResponse.results
    ];
    notifyListeners();
  }
